...
void print_futureInt(FutureInt *fut); // for debug purposes: pint a fut int status
...
// asynchronous funciton call:
// takes a function pointer as parameter and the fun call parameter as second param
// returns an unresolved future
// creates a thread to perform the async fun call
