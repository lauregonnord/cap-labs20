...
class RiscVFunction:
    ...
    def addInstructionJUMP(self, label):
        ...
        i = Instru3A("j", label)
        # TODO (lab5): properly build the CFG: don't chain with next
        # TODO (lab5): instruction to add, but with the target of the jump.
    ...
    def addInstructionCondJUMP(self, label, op1, c, op2):
        ...
        # TODO (lab5): properly build the CFG: chain with both the
        # TODO (lab5): next instruction to be added and with the
        # TODO (lab5): target of the jump.
        self.add_instruction(ins)
        return ins
